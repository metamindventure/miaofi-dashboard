...
// Insight severity mapping for collapsed dots
const insightSeverities: Array<{ id: string; severity: "critical" | "warning" | "tip"; label: string }> = [
  { id: "tslax", severity: "critical", label: "69% Single Stock" },
  { id: "rch", severity: "warning", label: "Micro-Cap Risk" },
  { id: "idle", severity: "tip", label: "Idle Stablecoins" },
  { id: "wbtc", severity: "warning", label: "Fragmented WBTC" },
];
...
const AIDiagnosis = () => {
  ...
  return (
    <section className="w-full space-y-0">
      ...
      {/* Collapsible Portfolio Analysis card */}
      <button
      ...
      >
        ...
        <div className="flex items-start gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-display font-bold text-base text-foreground">High Risk Portfolio</h3>
        ...
        <div className="flex items-center gap-6 mb-3">
          <div>
            <span className="text-[11px] text-muted-foreground block">Issues Found</span>
            <span className="text-lg font-bold font-mono text-foreground tabular-nums">4</span>
          </div>
          <div>
            <span className="text-[11px] text-muted-foreground block">Critical</span>
            <span className="text-lg font-bold font-mono text-loss tabular-nums">1</span>
          </div>
          <div>
            <span className="text-[11px] text-muted-foreground block">At Risk</span>
            <span className="text-lg font-bold font-mono text-loss tabular-nums">~$6,698</span>
          </div>
        </div>
        ...
        {!expanded && (
          <div className="flex items-center gap-2 text-muted-foreground">
            <span className="text-sm">
              Insights detected ({insightSeverities.length})
            </span>
            <div className="flex items-center gap-1.5">
              {insightSeverities.map((s) => (
                <span
                  key={s.id}
                  className={`w-2 h-2 rounded-full ${severityDotColor[s.severity]}`}
